...
public class WalkRouteOverlay extends RouteOverlay {
    ...
    private void addWalkPolyLine(LatLonPoint pointFrom, LatLonPoint pointTo) {
        addWalkPolyLine(MapUtils.latLonPointToLatLng(pointFrom), MapUtils.latLonPointToLatLng(pointTo));
    }
    ...
    private void addWalkPolyLines(WalkStep walkStep) {
        mPolylineOptions.addAll(MapUtils.latLonPointsToLatLngList(walkStep.getPolyline()));
    }
